...
class Nftcardsrow3ItemWidget extends StatelessWidget {
  Nftcardsrow3ItemWidget(this.nftcardsrow3ItemModelObj);

  Nftcardsrow3ItemModel nftcardsrow3ItemModelObj;

  var controller = Get.find<MarketplaceMobileController>();
          ...
          Align(
            ...
            child: ClipRRect(
              ...
              child: CommonImageView(
                imagePath: ImageConstant.imgImageplaceholder3,
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: CommonImageView(
                        imagePath: ImageConstant.imgAvatarplaceholder2,
                        height: getSize(
                          24.00,
                        ),
                        width: getSize(
