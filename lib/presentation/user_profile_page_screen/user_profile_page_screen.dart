import '../user_profile_page_screen/widgets/nftcardsrow1_item_widget.dart';
import 'controller/user_profile_page_controller.dart';
import 'models/nftcardsrow1_item_model.dart';
...
class UserProfilePageScreen extends GetWidget<UserProfilePageController> {
  @override
                                    ...
                                    Container(
                                        ...
                                        child: Obx(() => ListView.builder(
                                            ...
                                            itemCount: controller
                                                .userProfilePageModelObj
                                                .value
                                                .nftcardsrow1ItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              Nftcardsrow1ItemModel model =
                                                  controller
                                                          .userProfilePageModelObj
                                                          .value
                                                          .nftcardsrow1ItemList[
                                                      index];
                                              return Nftcardsrow1ItemWidget(
                                                  model);
                                            })))
                                  ]))
                        ]))),
