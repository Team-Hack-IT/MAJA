...
class Nftcardsrow1ItemWidget extends StatelessWidget {
  Nftcardsrow1ItemWidget(this.nftcardsrow1ItemModelObj);

  Nftcardsrow1ItemModel nftcardsrow1ItemModelObj;

  var controller = Get.find<UserProfilePageController>();
